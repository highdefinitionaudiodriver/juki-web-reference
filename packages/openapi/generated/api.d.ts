...
export interface paths {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            householdId?: string;
                            total?: number;
                            members?: components["schemas"]["Resident"][];
                        };
                    };
                };
                /** @description Not found */
    ...
    "/link/application/inbound": {
        ...
        get?: never;
        put?: never;
        /** 申請管理システム受信（市民ポータル等からのインバウンド申請。受付簿に取り込む） */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/certificates/fee": {
        ...
        get?: never;
        put?: never;
        /** 住民票等の証明手数料の算定（証明種別×通数＋郵送料。手数料額は条例パラメータ。VIEW） */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/link/applications/export": {
        ...
        /** オンライン申請 受付簿のCSV出力（VIEW, BOM付きUTF-8） */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/link/applications/{id}/status": {
        ...
        get?: never;
        put?: never;
        /** オンライン申請の処理状況更新（RECEIVED/PROCESSING/COMPLETED/REJECTED, VIEW） */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/system-info": {
        ...
        /** システム情報（Node版/稼働時間/データ件数等, 運用・監視用） */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/announcements": {
        ...
        put?: never;
        /** お知らせ登録（ADMIN, level=info/warning/critical） */
        post: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/export-all": {
        ...
        /** 契約終了時データ提供（全業務データの一括エクスポート, ADMIN） */
        get: {
            parameters: {
                query?: never;
                header?: never;
